...
import { Brain, Search, Plus, Trash2, Tag, X, BookOpen, Sparkles } from 'lucide-react'
...
export default function MemoryPanel() {
  ...
  return (
    <div className="flex flex-col h-full min-h-0 p-6 gap-5">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex rounded-xl overflow-hidden border border-white/10">
            <button
              ...
              style={{ background: view === 'galaxy' ? 'rgba(124,58,237,0.3)' : 'rgba(255,255,255,0.04)', color: view === 'galaxy' ? '#c4b5fd' : '#64748b' }}
            >
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 text-[11px] font-medium transition-colors"
              style={{ background: view === 'list' ? 'rgba(124,58,237,0.3)' : 'rgba(255,255,255,0.04)', color: view === 'list' ? '#c4b5fd' : '#64748b' }}
            >
              <Brain className="w-3 h-3" /> List
            </button>
          </div>
          <button
      ...
      {/* Galaxy view */}
      {view === 'galaxy' && (
        <div className="flex-1 relative rounded-2xl overflow-hidden min-h-0" style={{ minHeight: 400 }}>
          <MemoryGalaxy onOpenNote={() => {}} />
        </div>
      )}
