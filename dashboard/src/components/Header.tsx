...
export default function Header() {
  ...
  return (
    <motion.header
      ...
      className="glass-panel border-b border-indigo-500/20 px-6 py-3 flex items-center justify-between sticky top-0 z-50 scan-line-container"
    ...
    >
      ...
      <div className="flex items-center gap-4">
        <div className="relative flex items-center justify-center w-10 h-10">
          ...
          >
            <Hexagon className="w-10 h-10 text-violet-500" strokeWidth={1} />
          </motion.div>
          <Zap className="w-4 h-4 text-violet-300 relative z-10" />
        </div>

        <div>
          <h1 className="text-sm font-bold tracking-[0.3em] text-white glow-violet">
            AGENTOS
          </h1>
          <p className="text-[10px] tracking-[0.4em] text-indigo-400/70 uppercase">
            Mission Control
          </p>
        </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <button className="p-2 rounded-lg text-slate-400 hover:text-violet-400 hover:bg-violet-500/10 transition-colors">
          <Settings className="w-4 h-4" />
        </button>

        <button className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-violet-500/10 border border-violet-500/20 hover:border-violet-500/40 transition-colors">
          ...
          <span className="text-xs text-violet-300 hidden md:block">Admin</span>
        </button>
      </div>
    </motion.header>
  )
